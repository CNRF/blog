...
public class AtomicStampedReferenceExample {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread thread1 = new Thread(() -> {
            ...
            // 模拟 A -> B -> A 的变化
            boolean success1 = atomicStampedRef.compareAndSet(currentRef, currentStamp, "B", currentStamp + 1);
            System.out.println("Thread 1: CAS operation (A -> B): " + success1);

            boolean success2 = atomicStampedRef.compareAndSet("B", currentStamp + 1, "A", currentStamp + 2);
        ...
        Thread thread2 = new Thread(() -> {
            ...
            boolean success = atomicStampedRef.compareAndSet("A", 1, "C", 2);
...
public class AtomicMarkableReferenceExample {
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread thread1 = new Thread(() -> {
            ...
            // 模拟 A -> B -> A 的变化
            boolean success1 = atomicMarkableRef.compareAndSet(currentRef, currentMark, "B", !currentMark);
            System.out.println("Thread 1: CAS operation (A -> B): " + success1);

            boolean success2 = atomicMarkableRef.compareAndSet("B", !currentMark, "A", !currentMark);
            System.out.println("Thread 1: CAS operation (B -> A): " + success2);
        });
        ...
        Thread thread2 = new Thread(() -> {
            ...
            boolean success = atomicMarkableRef.compareAndSet("A", false, "C", true);
            System.out.println("Thread 2: CAS operation (A -> C): " + success);
        });
