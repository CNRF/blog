...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">--appendonly </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">yes</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br></div></div><p>命令解释说明：</p><p><strong>-p 6379:6379</strong> 端口映射：前表示主机部分，：后表示容器部分。</p><p><strong>--name dockerredis</strong> 指定该容器名称，查看和进行操作都比较方便。</p><p><strong>-v</strong> 挂载目录，规则与端口映射相同。</p><p>为什么需要挂载目录：个人认为docker是个沙箱隔离级别的容器，这个是它的特点及安全机制，不能随便访问外部（主机）资源目录，所以需要这个挂载目录机制。</p><p><strong>-d redis</strong> 表示后台启动redis</p><p><strong>redis-server /etc/redis/redis.conf</strong> 以配置文件启动redis，加载容器内的conf文件，最终找到的是挂载的目录/mnt/redis/redis.conf</p>`,14),l=[i];function r(c,t,d,b,h,o){return n(),a("div",null,l)}const m=s(e,[["render",r]]);export{k as __pageData,m as default};
